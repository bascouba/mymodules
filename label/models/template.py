...
class Template(models.Model):
	...
	label=fields.One2many(comodel_name='label.label', inverse_name='template')
	config=fields.One2many(comodel_name='label.config.settings', inverse_name='template_gestion')
